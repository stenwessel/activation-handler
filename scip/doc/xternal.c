...
/**@defgroup PublicActivationHandlerMethods Activation Handlers
 * @ingroup PluginManagementMethods
 * @brief  methods for activation handler plugins
 */
...
/**@defgroup ACTIVATIONHDLR Activation Handler
 * @ingroup PUBLICPLUGINAPI
 * @brief methods and files provided by the default activation handlers of \SCIP
 *
 * A detailed description what an activation handler does and how to add an activation handler to SCIP can be found
 * \ref ACTIVATION "here". (TODO)
 */

/**@defgroup ActivationhdlrIncludes Inclusion methods
 * @ingroup ACTIVATIONHDLR
 * @brief methods to include specific activation handlers into \SCIP
 *
 * This module contains methods to include specific activation handlers into \SCIP.
 *
 * @note All default plugins can be included at once (including all default activation handlers) using SCIPincludeDefaultPlugins()
 *
 */
