...
struct SCIP_Set
{
   ...
   SCIP_ACTIVATIONHDLR** activationhdlrs;    /**< activation handlers */
   ...
   int                   nactivationhdlrs;   /**< number of activationhdlrs array */
   int                   activationhdlrssize;/**< size of activation handlers */
