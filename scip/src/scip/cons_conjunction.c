...
{  /*lint --e{715}*/
   ...
   SCIP_CALL( SCIPcreateCons(scip, targetcons, SCIPconsGetName(sourcecons), conshdlr, targetdata, NULL,
   ...
   )
{
   ...
   /* create constraint */
   SCIP_CALL( SCIPcreateCons(scip, cons, name, conshdlr, consdata, NULL, FALSE, FALSE, enforce, check, FALSE,
