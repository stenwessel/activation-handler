   ...
   )
{
   ...
   case SCIP_STAGE_PROBLEM:
      SCIP_CALL( SCIPconsCreate(cons, scip->mem->probmem, scip->set, name, conshdlr, consdata, activationhdlr,
 ...
 *       - \ref SCIP_STAGE_SOLVING
 */
SCIP_RETCODE SCIPsetConsActivationhdlr(
   SCIP*                 scip,               /**< SCIP data structure */
   SCIP_CONS*            cons,               /**< constraint */
   SCIP_ACTIVATIONHDLR*  activationhdlr      /**< activation handler */
   )
{
   SCIP_CALL( SCIPconsSetActivationhdlr(cons, activationhdlr) );
